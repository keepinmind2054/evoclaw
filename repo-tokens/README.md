...
```yaml
- uses: qwibitai/evoclaw/repo-tokens@v1
  with:
    include: 'src/**/*.ts'
    exclude: 'src/**/*.test.ts'
```
...
| Repo | Badge |
|------|-------|
| [EvoClaw](https://github.com/qwibitai/EvoClaw) | ![tokens](https://raw.githubusercontent.com/qwibitai/EvoClaw/main/repo-tokens/badge.svg) |
