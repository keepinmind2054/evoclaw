...
class TestTelegramUnauthorized:
    ...
    async def test_unauthorized_logs_critical(self, caplog):
        ...
        class FakeUnauthorized(FakeForbidden):
            pass

        fake_tg_error_mod = types.ModuleType("telegram.error")
        fake_tg_error_mod.Forbidden = FakeForbidden
        ...
        fake_telegram.__path__ = []
        fake_telegram.error = fake_tg_error_mod
        fake_telegram.Update = MagicMock
        fake_telegram.Bot = MagicMock

        fake_tg_ext_mod = types.ModuleType("telegram.ext")
        fake_tg_ext_mod.Application = MagicMock
        fake_tg_ext_mod.MessageHandler = MagicMock
        fake_tg_ext_mod.CommandHandler = MagicMock
        fake_tg_ext_mod.filters = MagicMock
        fake_tg_ext_mod.ContextTypes = MagicMock
...
class TestWhatsAppTokenRevocation:
    ...
    async def test_http_401_logs_critical(self, caplog, tmp_path):
        ...
        with caplog.at_level(logging.CRITICAL, logger="host.channels.whatsapp_channel"):
            await channel.send_message("wa:12345:67890", "test")
    ...
    async def test_http_401_aborts_no_retry(self, tmp_path):
        ...
        await channel.send_message("wa:12345:67890", "hello")
...
class TestDiscordLoginFailure:
    ...
    def test_login_failure_logs_critical(self, caplog):
        ...
        fake_discord.Message = MagicMock
        fake_discord.abc = MagicMock()
        fake_discord.abc.Messageable = MagicMock
